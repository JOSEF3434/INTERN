...
const FoodA = () => {
    ...
    // Fetch products of type 'food' when component mounts
    useEffect(() => {
        fetchProducts();
    }, []);
    ...
    const fetchProducts = async () => {
        try {
            const response = await axios.get('http://localhost:5000/api/products?type=food');
    ...
    return (
        <div className="grid md:grid-cols-4">
            ...
            <div className="container mx-auto p-5 col-span-3">
                <h2 className="text-3xl font-bold mb-4 text-center">Food Products</h2>
